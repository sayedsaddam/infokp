...
<head>
	...
	<title>Saddam Hussain (Sayed)</title>
    ...
    <main>
        ...
        <div class="container">
            ...
            <section id="about" class="section feature-box mb-5">
                ...
                <p class="text-center w-responsive mx-auto wow fadeIn my-5" data-wow-delay="0.2s">Born in the most hospitable provice of Pakistan, called Khyber Pakhtunkhwa's district of Swat (the Switzerland of Asia) in 1993, got my early education in hometown, graduated in early 2016 with the major in Computer Science, at the University of Agriculture, Peshawar-Pakistan. Started my professional career in May, 2016.</p>
                ...
                <div class="row features-big text-center wow fadeIn" data-wow-delay="0.4s">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="card card-body hoverable">
                            ...
                            <p class="dark-grey-text">Working on freelance project in my free time.</p>
                        </div>
                        <!--/.Panel-->
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="card card-body yellow hoverable">
                            ...
                            <p class="dark-grey-text">Full time Web Developer at Al Hayyat Group of Companies.</p>
                        </div>
                        <!--/.Panel-->
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="card card-body hoverable">
                            ...
                            <p class="dark-grey-text">Doing some designing stuff mostly on weekends.</p>
                        </div>
                        <!--/.Panel-->
                ...
                <section id="skills">
                    ...
                    <div class="row py-5">
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <!--Description-->
                            <p class="black-text text-uppercase font-weight-bold" align="justify">PHP / Codeigniter</p>
                                <div class="md-progress">
                                    <div class="progress-bar" role="progressbar" style="width: 90%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>

                            <p class="black-text text-uppercase font-weight-bold pt-3" align="justify">MySQL</p>
                                <div class="md-progress">
                                    <div class="progress-bar" role="progressbar" style="width: 65%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>

                            <p class="black-text text-uppercase font-weight-bold pt-3" align="justify">HTML5 / CSS3</p>
                                <div class="md-progress">
                            ...
                            <p class="black-text text-uppercase font-weight-bold pt-3" align="justify">jQuery / AJAX</p>
                                <div class="md-progress">
                                    <div class="progress-bar" role="progressbar" style="width: 53%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>

                            <p class="black-text text-uppercase font-weight-bold pt-3" align="justify">json</p>
                                <div class="md-progress">
                                    <div class="progress-bar" role="progressbar" style="width: 53%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>

                            <p class="black-text text-uppercase font-weight-bold pt-3" align="justify">Laravel, Python(beginner)</p>
                                <div class="md-progress">
                                    <div class="progress-bar" role="progressbar" style="width: 53%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
        ...
        <div class="container">
            ...
            <section class="section feature-box my-5 pb-5">
                ...
                <p class="text-center w-responsive mx-auto wow fadeIn my-5" data-wow-delay="0.2s"> The process of creating things and get them to work has three different phases including Research, Design, and Development.</p>
                    ...
                    <div class="tab-content card">
                        ...
                        <div class="tab-pane fade in show active" id="panel1" role="tabpanel">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-9 mb-2">
                                    <p class="dark-grey-text">Research is the key to develop a perfect product that runs for decades.</p>
                                </div>
                            </div>
                        </div>
                        <!--/.Panel 1-->
                        ...
                        <div class="tab-pane fade" id="panel2" role="tabpanel">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-9 mb-2">
                                    <p class="dark-grey-text">"Design is not just what it looks like and feels like. Design is how it works." Design is the very first thing the user sees, so your design should build some good impressions on the user.</p>
                                </div>
                            </div>
                        </div>
                        <!--/.Panel 2-->
                        ...
                        <div class="tab-pane fade" id="panel3" role="tabpanel">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-9 mb-2">
                                    <p class="dark-grey-text">And last but not the least, Development, the important attribute in a prduct lifecycle.</p>
                                </div>
                            </div>
                        </div>
                        <!--/.Panel 3-->
        ...
        <div class="container">
            ...
            <section id="works" class="section mb-5">
                ...
                <!-- Section description -->
                <p class="text-center w-responsive mx-auto wow fadeIn my-5">Here we go, let's have a look at the products that I've worked on.</p>
