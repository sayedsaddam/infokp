...
.img-gradient:after {
    ...
    <main>
        ...
        <!-- Section: Services -->
            <section class="text-center py-5">
                <div class="container">
                    <h2 class="h1-responsive font-weight-bold mb-5">Services</h2>
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <!-- Card -->
                            <div class="card card-image hoverable"
        ...
        <!--Section: Panels card -->
            <section class="text-center py-5">
                <div class="container">
                    <h2 class="h1-responsive font-weight-bold mb-5">Panels Card <small class="font-weight-normal" style="font-size: 20px; color: crimson;">This one's amazing! <i class="fas fa-heart"></i></small></h2>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="card panels-card hoverable">
        ...
        <!--Section: Gradient cards and expandable -->
            <section class="py-5">
                <div class="container">
                    <h2 class="h1-responsive font-weight-bold mb-5 text-center">Gradient cards and expandable</h2>
                    <!--Grid row-->
                    <div class="row">
                    <!--Grid column-->
                    <div class="col-md-6 mb-4">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <!-- Card Narrower -->
                        <div class="card card-cascade hoverable overlay wider">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <p>Office #11, 2<sup>nd</sup> floor, Umer bldg, Jinnah Avenue, Blue Area, Islamabad, Pakistan.</p>
                        </li>
                        <li>
                        <i class="fa fa-phone fa-2x mt-4 purple-text"></i>
                        <p>+92 333 222 2259<br>+92 51 111 678 678</p>
                        </li>
                        <li>
                        <i class="fa fa-envelope fa-2x mt-4 purple-text"></i>
                        <p class="mb-0">info@s2smark.com</p>
                        </li>
                    </ul>
                    </div>
                    <!-- Grid column -->
